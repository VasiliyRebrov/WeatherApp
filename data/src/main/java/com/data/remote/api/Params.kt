...
sealed class Params {
    data class WeatherParams private constructor(
        val lat: String,
        val lon: String,
        ...
        companion object {
            fun createParams(city: City, unitMeasurePref: String) = WeatherParams(
                lat = city.latitude,
                lon = city.longitude,
    ...
    data class CitiesParams private constructor(
        ...
        companion object {
            fun createParamsByName(namePrefix: String) = CitiesParams(
                namePrefix = namePrefix,
                sort = "-population"
            )

            fun createParamsByLoc(location: Location) = CitiesParams(
